...
def _test_extend_attention_sliding_window_once(
        B, N_CTX, H_Q, H_KV, D, WINDOW_SIZE
    ):
...
if __name__ == "__main__":
    torch.manual_seed(0)
    B, N_CTX, H_Q, H_KV, D, WINDOW_SIZE = 19, 121, 64, 8, 128, -1
    _test_extend_attention_sliding_window_once(B, N_CTX, H_Q, H_KV, D, WINDOW_SIZE)