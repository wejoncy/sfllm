...
if _is_hip:
    ...
    def use_w8a8_block_fp8_matmul_unrolledx4(M, N, META):
        ...
        num_workgroups <= current_platform.get_device_core_count()
...
if _is_cuda:
    ...
    if not get_bool_env_var("SGLANG_DISABLE_SGL_KERNEL_FAKE_REGISTER"):
        ...
        @torch.library.register_fake("sfkernels::sgl_per_token_quant_fp8")
        def _(input, output_q, output_s):
            return

    @torch.library.register_fake("sfkernels::sgl_per_tensor_quant_fp8")
